...
| 37 | 원고 작업 3단계 시각 단순화 | PASS | 콤팩트 제목·동작 정렬, 8px 문단 간격, 단일 활성 원고 도구, 결과 견본형 완성 설정, 수정 버튼 없는 최종 요약, 390px·360px 단계 전환 상단 복귀 |
| 38 | 로어북 로컬 열람 테마 | PASS | 밝은 양피지·형광 CRT 글리치·남색 도시 네온 역할, 어두운 작업면 여백, 공통 편집 버튼, 전환/새로고침 유지, 읽기·편집 대비, 본문·내보내기 불변, desktop/mobile/narrow overflow 검사 |
